  ...
  useEffect(() => {
    Promise.all([
      ...
      .then(([s, a]) => {
        ...
        setActors(a.filter((u) => u.role === "actor").sort((a, b) => a.lastName.localeCompare(b.lastName)));
      })
      .catch(console.error)
  ...
  return (
    <div>
      ...
      <p style={{ color: "var(--text-muted)", marginBottom: "1.5rem" }}>
        Enter sign-ins from a printed attendance sheet after internet is
        restored.
      </p>
